...
4. Check stack rules: Mantine/Tailwind/RHF usage per `stack/*`, accessibility per `engineering/frontend`, naming per `engineering/naming`, types per `engineering/typescript`.
